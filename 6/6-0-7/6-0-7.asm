...
;Вариант №6-0-1
;Задание: В двух данных строках определите количество совпадающих символов, стоящих на одинаковой позиции в строке.
...
task		db	'В двух данных строках определите количество совпадающих символов, стоящих на одинаковой позиции в строке.', 10,13,'$'
answer		db	'Ответ: $'
